                ...
                <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
                    ...
                    <div
                        className="prose prose-indigo max-w-none
                            ...
                            text-gray-50 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-gray-700
                            ...
                            prose-table:w-full prose-th:text-left prose-th:font-semibold prose-th:pb-2 prose-td:py-2 prose-td:border-b prose-td:border-indigo-100"
